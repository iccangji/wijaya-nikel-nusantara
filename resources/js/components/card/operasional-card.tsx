                    ...
                    <Table>
                        ...
                        <TableHeader>
                            <TableRow>
                                ...
                                <TableHead className="text-center w-[100px]">Alat</TableHead>
                        ...
                        <TableBody>
                            {
                                operasionalData.map((operasional: any, idx: number) => (
                                    ...
                                    >
                                        ...
                                        <TableCell className="text-center">{operasional.alat.alat}</TableCell>
                                        <TableCell className="text-center">{operasional.jam_operasional}</TableCell>
                                        <TableCell className="text-center">{operasional.retase}</TableCell>

...
export default function OperasionalFormEdit() {
    const { operasional, alatData, flash } = usePage().props
    const { data, setData, post, processing, errors } = useForm({
        tanggal: operasional ? operasional.tanggal : '',
        alat_id: operasional ? operasional.alat_id.toString() : '',
        jam_operasional: operasional ? operasional.jam_operasional : '',
        retase: operasional ? operasional.retase : '',
        solar: operasional ? operasional.solar : '',
    })

    const submit = (e: React.FormEvent) => {
        e.preventDefault();

        post(`/operasional/${operasional.id}/?_method=PUT`,);
    };
    useEffect(() => {
